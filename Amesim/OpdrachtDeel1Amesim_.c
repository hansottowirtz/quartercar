...
static ParamInfo ModelParamInfo[ NB_PARAMS ] = {
   ...
   {StateVar,         Expression,     2,    17, STATE_CATEGORY,         3},
   {StateVar,         Expression,     3,    18, STATE_CATEGORY,         3},
...
static void SetInitValues(AMESIMSYSTEM *amesys)
{
   ...
   ChangeState(&y[2], v[17]);
   ChangeState(&y[3], v[18]);
   ChangeState(&y[0], v[4]);
   ChangeState(&y[1], v[5]);
...
static void Initialize(AMESIMSYSTEM *amesys, double *y)
{
   ...
   n = 1;
   mas002in_(&n, RP3, RS3, IS3, &y[2], &y[3], NULL, NULL, NULL
      , NULL);
...
static void localFunctionEval(AMESIMSYSTEM *amesys, double *dot, double *y, double t, int *flag)
{
   ...
   *oldflag = *newflag = sflag;
   ...
   v[0] = -v[17] /* Duplicate variable. */;
   AME_POST_SUBMODCALL_NO_DISCON(flag);

   v[1] = -v[18] /* Duplicate variable. */;
   AME_POST_SUBMODCALL_NO_DISCON(flag);
   ...
   *oldflag = *newflag = sflag;
   ...
   n = 1;
   *oldflag = *newflag = sflag;
   mas002_(&n, &v[17], &dot[2], &v[18], &dot[3], &v[19], &v[20]
      , &v[3], NULL, NULL, &v[26], NULL, NULL, NULL, NULL, &v[27]
      , NULL, NULL, RP3, RS3, IS3);
   AME_POST_SUBMODCALL_WITH_DISCON(flag,&sflag,&oflag,&panic,"MAS002",1);

   v[2] = -v[19] /* Duplicate variable. */;
   AME_POST_SUBMODCALL_NO_DISCON(flag);
...
static void localJFunctionEval(AMESIMSYSTEM *amesys, double *dot, double *y, double t, int col)
{
   ...
   switch (col)
   {
      case 0:
         ...
         v[7] = v[3] /* Duplicate variable. */;
         n = 1;
         mas002_(&n, &v[17], &dot[2], &v[18], &dot[3], &v[19]
            , &v[20], &v[3], NULL, NULL, &v[26], NULL, NULL, NULL
            , NULL, &v[27], NULL, NULL, RP3, RS3, IS3);
         v[2] = -v[19] /* Duplicate variable. */;
         n = 1;
