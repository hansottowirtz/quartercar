...
OpdrachtDeel1Amesim_.dll: $(OBJECTS) OpdrachtDeel1Amesim_.o
	@echo OpdrachtDeel1Amesim_.make.link_args =
	@type OpdrachtDeel1Amesim_.make.link_args
	"$(AME)\interfaces\standalonesimulator\win32\stdsim_dynlink"  $(CC) $(LDFLAGS) -o OpdrachtDeel1Amesim_.dll OpdrachtDeel1Amesim_.o @"OpdrachtDeel1Amesim_.make.link_args" $(AMELIBS)
